...
<div id="header">
    ...
    <A href="index"><IMG SRC="../resources/images/images/home1.gif"></IMG></A>	
</div>
    ...
    <td width="450" valign="top">
		...
		<tr>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
				<form name=F1 onSubmit="return dil(this)" action="transferAmount" >
				    <table cellspacing="5" cellpadding="3">
				    <tr><td>ACCOUNT NO:</td><td> <input type="text" name="sourceAccountNo" required/></td></tr>
					<tr><td>USER NAME:</td><td> <input type="text" name="username" required/></td></tr>
					<tr><td>PASSWORD:</td><td> <input type="password" name="password" required/></td></tr>
					<tr><td>TARGET ACCOUNT NO:</td><td><input type="text" name="destinationAccountNo" required/></td></tr>
