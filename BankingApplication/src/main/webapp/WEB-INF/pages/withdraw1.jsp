...
<div id="header">
    ...
    <A href="index"><IMG SRC="../resources/css/images/home1.gif"></IMG></A>
</div>
...
<tr >
    ...
    <td width="1200" valign="top">
		...
		<tr>
			<td>
			<div><%if(session.getAttribute("invalidWithdraw")!=null)
			{
			out.print(request.getAttribute("invalidWithdraw"));
			}
			
			 %></div>
				<form name=F1 onSubmit="return dil(this)" action="withdrawAmount" >
