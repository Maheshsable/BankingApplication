...
<tr >
    ...
    <td width="1200" valign="top">
		...
		<tr>
			<td><div><%if(session.getAttribute("amountFailure")!=null)
			{
			String result=(String)session.getAttribute("amountFailure");
			%>
			<p  style=color:green>
			<%
			out.print(result);
			...
			%>
				...
				<form name=F1 onSubmit="return dil(this)" action="depositAmmount" >
